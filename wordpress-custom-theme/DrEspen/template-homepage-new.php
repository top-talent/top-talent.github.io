...
<script src="//widget.manychat.com/289657057728000.js" async="async"></script>
...
-->
<div class="container featured-wrap page-banner-holder"> 
	<div class="row">
		<div class="col-lg-12">
		
		<ul>
			<li class="title">Featured In:</li>
			<?php
				$args = array( 'post_type' => 'company_logos','orderby'=>"date","order"=>"ASC");
	                        ...
	                        <div class="owl-item active col-lg-6 col-md-6 col-sm-6 col-xs-6 smaller">
	                            <div class="item">
	                                <a href="/articles/personal-development/">
										<img src="https://www.drespen.com/wp-content/uploads/2018/08/sucess.jpg" alt="empowerment articles">
									<div class="categories_item_descr">
