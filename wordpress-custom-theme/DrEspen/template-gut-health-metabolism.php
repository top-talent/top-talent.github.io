<?php
/**
 * Template Name: Gut Health and Metabolism Template
 */
?>
...
<div class="container teal_bg page-banner-holder"> 
	<div class="row">
		<div class="col-lg-12 page-banner">
			<h4>Gut Health and Metabolism</h4>
...
$args = array( 'post_type' => 'articles', 'category_name' => 'gut-health-and-metabolism', 'posts_per_page' => 6, 'paged' => $paged );
