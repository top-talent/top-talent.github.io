 ...
 * Template Name: General Page - Typeform wheel of Life
 */
...
<form id="final-submit" method="post" style="display:none">
	...
	<div class="is_form_wrapper">
		<div class="infusion-field step-2-heading">
			...
			So We Can Provide You With Your Results. Please Enter Your Details Below.</span>
		</div>
		<div class="infusion-field">
			...
			<input class="infusion-field-input-container" id="inf_field_FirstName" name="inf_field_FirstName" type="text" />
				...
				<div class="infusion-field">
					...
					<div class="subheading" style="display:none;">Do You Wish To Receive A Complimentary Strategy Session With One Of Our Qualified Coaches (Value $175).</div>
					<div class="complimentary" style="display:none;"><span class="yes">Yes</span><span class="no">No</span></div>
				</div>
				...
				<div class="infusion-field  custom-inf-WLSMein10Years" style="display:none;">
				...
				<div class="infusion-field custom-inf-WLSRoadBlocks">
					...
					<label for="inf_custom_WLSRoadBlocks "><span class="question-number">7 -></span><span class="label-text">What are the 3 biggest road blocks in your life right now?</span></label>
				...
				<div class="infusion-field custom-inf-WLS">
					...
					<label for="inf_custom_WLSpersonalorprofessionalvision "><span class="question-number">8 -></span><span class="label-text">Do you have a personal or professional vision for your life?
				...
				<div class="infusion-field gai custom-gai" style="display:none;">
				...
				<div class="infusion-field gai2 custom-gai2" style="display:none;">
				 ...
				 <div class="infusion-field custom_Thankforreferringyou">
							...
							<label for="inf_custom_questions_comments"><span class="question-number">9 -></span><span class="label-text"> If you have any additional questions or comments for our coaching team, then please enter here:</span></label>
							<textarea cols="24" class="infusion-field-input" id="inf_custom_questions_comments" name="inf_custom_questions_comments" rows="5"></textarea>
					...
					<div class="infusion-submit">
                        <input type="hidden" name="status" id="wol-status" value="WOL">
	...
	<div class="thank-you" style="display:none">
		...
		<br>
		<!--/ Return to <a href="www.drespen.com" target="__blank">www.drespen.com</a></p>-->
...
var saveResult8 = function (data) {
	...
	jQuery(".complimentary .yes").on("click",function(){
		...
		jQuery('.custom-inf-WLSMein12months,.custom-inf-WLSRoadBlocks,.custom-inf-WLSRoadBlocks').show();
...
jQuery("#is-form-submit").click(function(e) {
	...
	"submit":"WOL",
		...
		'inf_custom_questions_comments': jQuery("#inf_custom_questions_comments").val(),
...
.step-2-heading{
	...
	.newsletter-section, #about-espen, .footer-copyright .TGA-text {
		display: none;
	}

    .page-id-3938 .survey-header_new {
    display: block;
}
