<?php
/**
 * Template Name: General Page - Typeform Survey 2
 */
?>
	...
	.submit-loading-img-active {
		display: block;
			...
			<div class="is_form_wrapper">
				...
				<div class="infusion-field">
					<label for="inf_field_Email"><span class="question-number">3 -></span><span class="label-text">What is your <strong>email address</strong>?<span class="asterisk">*</span></span></label>
					<div class="subheading">(Please ensure spelling is correct)</div>
					<input class="infusion-field-input-container" id="inf_field_Email" name="inf_field_Email" type="text" />
				</div>
				<div class="infusion-field gai">
					<label for="inf_custom_WLSGrossAnnualIncome"><span class="question-number">4 -></span><span class="label-text">What is your gross annual income? (Rough estimate)</span></label>
				...
				<div class="infusion-field">
					<label for="inf_custom_WLSPlannedInvestmentinSelfDevelopment"><span class="question-number">5 -></span><span class="label-text">Assuming we get the results and reach the goals you are after, how much are you willing to invest in self development per annum?</span></label>
				...
				<div class="infusion-field">
					<label for="inf_custom_MentalAndEmotionalState"><span class="question-number">6 -></span><span class="label-text">Mental and emotional state</span></label>
					<div class="subheading">Rate this aspect in your life from a scale of 1 (lowest) to 100 (highest).</div>
				...
				<div class="infusion-field">
					<label for="inf_custom_WLSCareerVocationPurpose"><span class="question-number">7 -></span><span class="label-text">Career/vocation/purpose</span></label>
					<div class="subheading">Rate this aspect in your life from a scale of 1 (lowest) to 100 (highest).</div>
				...
				<div class="infusion-field">
					<label for="inf_custom_WLSRelationships"><span class="question-number">8 -></span><span class="label-text">Relationships</span></label>
					<div class="subheading">Rate this aspect in your life from a scale of 1 (lowest) to 100 (highest).</div>
					<input class="infusion-field-input-container" id="inf_custom_WLSRelationships" name="inf_custom_WLSRelationships" type="text" />
				</div>
				<div class="infusion-field">
					<label for="inf_custom_WLSTime"><span class="question-number">9 -></span><span class="label-text">Time</span></label>
					<div class="subheading">Rate this aspect in your life from a scale of 1 (lowest) to 100 (highest).</div>
					<input class="infusion-field-input-container" id="inf_custom_WLSTime" name="inf_custom_WLSTime" type="text" />
				</div>
				<div class="infusion-field">
					<label for="inf_custom_WLSFinancial"><span class="question-number">10 -></span><span class="label-text">Financial</span></label>
					<div class="subheading">Rate this aspect in your life from a scale of 1 (lowest) to 100 (highest).</div>
					<input class="infusion-field-input-container" id="inf_custom_WLSFinancial" name="inf_custom_WLSFinancial" type="text" />
				</div>
				<div class="infusion-field">
					<label for="inf_custom_WLSPhysicalHealth"><span class="question-number">11 -></span><span class="label-text">Physical Health</span></label>
					<div class="subheading">Rate this aspect in your life from a scale of 1 (lowest) to 100 (highest).</div>
					<input class="infusion-field-input-container" id="inf_custom_WLSPhysicalHealth" name="inf_custom_WLSPhysicalHealth" type="text" />
				</div>
				<div class="infusion-field">
					<label for="inf_custom_WLSSpiritualFulfillment"><span class="question-number">12 -></span><span class="label-text">Spiritual Fulfillment</span></label>
					<div class="subheading">Rate this aspect in your life from a scale of 1 (lowest) to 100 (highest).</div>
				...
				<div class="infusion-field">
					<label for="inf_custom_WLSPersonalDevelopment"><span class="question-number">13 -></span><span class="label-text">Personal Development</span></label>
					<div class="subheading">Rate this aspect in your life from a scale of 1 (lowest) to 100 (highest).</div>
				...
				<div class="infusion-field">
					<label for="inf_custom_WLSMein51020Years"><span class="question-number">14 -></span><span class="label-text">Where do you want to be in 5, 10 and 20 years from today?</span></label>
				...
				<div class="infusion-field">
					<label for="inf_custom_WLSRoadBlocks"><span class="question-number">15 -></span><span class="label-text">What are the 3 biggest road blocks in your life right now?</span></label>
					<textarea class="infusion-field-input-container" id="inf_custom_WLSRoadBlocks" name="inf_custom_WLSRoadBlocks"></textarea>
				</div>
				<div class="infusion-field">
					<label for="inf_custom_WLSRoadBlocksNegativeImpact"><span class="question-number">16 -></span><span class="label-text">How have these 3 roadblocks been holding you back and negatively affecting your life?</span></label>
				...
				<div class="infusion-field">
					<label for="inf_custom_WLSTopValues"><span class="question-number">17 -></span><span class="label-text">In three single words, please tell us your top three values in your life.</span></label>
				...
				<div class="infusion-field">
					<label for="inf_custom_WLSTopValues"><span class="question-number">18 -></span><span class="label-text">The Ultimate Wheel of Life</span></label>
