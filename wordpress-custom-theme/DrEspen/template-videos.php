...
$args = array( 'post_type' => 'articles', 'category_name' => 'Videos', 'posts_per_page' => 6, 'paged' => $paged );
$loop = new WP_Query( $args );
while ( $loop->have_posts() ) : $loop->the_post();
?>


							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 article-card video-card-override">
...
<div class="row">
	<div class="text-center">
	  ...
	  <?php wp_reset_postdata(); ?>
			...
			<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 hidden-xs newest-products">
