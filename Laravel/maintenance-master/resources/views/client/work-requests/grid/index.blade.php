...
<section class="panel panel-default panel-grid">
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle collapsed" data-toggle="collapse"
                            data-target="#work-requests-actions">
                ...
                <div class="collapse navbar-collapse" id="work-requests-actions">
                    ...
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li class="primary">
                            <a href="{{ route('maintenance.client.work-requests.create') }}" data-toggle="tooltip"
                    ...
                    <form class="navbar-form navbar-right" method="post" accept-charset="utf-8" data-search
                          data-grid="work-requests" role="form">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                ...
                                <button data-toggle="tooltip" data-original-title="Refresh" class="btn btn-default"
                                        data-grid="work-requests" data-reset>
    ...
    <div class="table-responsive">
        ...
        <table id="work-requests-results" class="table table-hover"
               data-source="{{ route('maintenance.api.v1.client.work-requests.grid') }}" data-grid="work-requests">
