...
<!-- Modal -->
<div class="modal fade" id="assetCategoryModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="asset-category-tree"></div>
            </div>

            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <button id="asset-category-select" type="button" class="btn btn-primary" disabled="disabled"
    ...
    $(document).ready(function (e) {
        ...
        $.get("{{ route('maintenance.api.v1.assets.categories.grid') }}", function (data) {
            ...
            if (json_category_tree != null) {
                $('#asset-category-tree').on('select_node.jstree', function (e, data) {

                    $('#asset-category-select').attr('disabled', false);
