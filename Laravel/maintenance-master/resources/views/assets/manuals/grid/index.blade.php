...
<section class="panel panel-default panel-grid">
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle collapsed" data-toggle="collapse"
                            data-target="#asset-manuals-actions">
                ...
                <div class="collapse navbar-collapse" id="asset-manuals-actions">
                    ...
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li class="primary">
                            <a href="{{ route('maintenance.assets.manuals.create', [$asset->id]) }}"
                    ...
                    <form class="navbar-form navbar-right" method="post" accept-charset="utf-8" data-search
                          data-grid="assets-manuals" role="form">
                            ...
                            <input class="form-control" name="filter" type="text" placeholder="Search">
                                ...
                                <span class="input-group-btn">
                                    ...
                                    <button data-toggle="tooltip" data-original-title="Refresh" class="btn btn-default"
                                            data-grid="assets-manuals" data-reset>
    ...
    <div class="table-responsive">
        ...
        <table id="assets-manuals-results" class="table table-hover"
               data-source="{{ route('maintenance.api.v1.assets.manuals.grid', [$asset->id]) }}"
               data-grid="assets-manuals">
    ...
    @include('assets.manuals.grid.templates.no-results')
    @include('assets.manuals.grid.templates.results')
    @include('layouts.partials.grid.templates.pagination', ['grid' => 'assets-manuals'])
    @include('layouts.partials.grid.templates.filters', ['grid' => 'assets-manuals'])
